...
resource "azurerm_postgresql_flexible_server" "azure_postgresql" {
  ...
  administrator_login           = azurerm_key_vault_secret.keyvault_secret1.value              #"dexter"
  administrator_password        = azurerm_key_vault_secret.keyvault_secret2.value             #"Admin123"
  zone                          = "1"
